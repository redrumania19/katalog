(function () {
  ...
  var UI = {
    en: {
      ...
      "contact.address": "Address", "contact.hours": "Opening Hours", "contact.getDirections": "📍 Get Directions",
    ...
    ar: {
      ...
      "contact.address": "العنوان", "contact.hours": "ساعات العمل", "contact.getDirections": "📍 احصل على الاتجاهات",
    ...
    es: {
      ...
      "contact.address": "Dirección", "contact.hours": "Horario de Atención", "contact.getDirections": "📍 Cómo Llegar",
    ...
    el: {
      ...
      "contact.address": "Διεύθυνση", "contact.hours": "Ώρες Λειτουργίας", "contact.getDirections": "📍 Δρομολόγηση",
    ...
    fr: {
      ...
      "contact.address": "Adresse", "contact.hours": "Horaires d'Ouverture", "contact.getDirections": "📍 Itinéraire",
    ...
    ru: {
      ...
      "contact.address": "Адрес", "contact.hours": "Часы Работы", "contact.getDirections": "📍 Проложить Маршрут",
    ...
    de: {
      ...
      "contact.address": "Adresse", "contact.hours": "Öffnungszeiten", "contact.getDirections": "📍 Route Planen",
